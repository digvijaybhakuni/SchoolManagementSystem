...
<body style="background-color: rgb(225, 248, 237);">
	...
	<div style="font-size: xx-large; color: green; text-align: center;">Management Panel</div>
	<center>
	<div style="border: 1px solid gray; width: 1025px;">
	<table width="100%">
	<tr>
	<td class="tdFormat" style="background-color: silver; cursor: pointer;" width="20%" onclick="openThisForm('user')">User Registration</td>
	<td  class="tdFormat" style="background-color: silver; cursor: pointer;" width="20%" onclick="openThisForm('report')">Report</td>
	<td class="tdFormat" style="background-color: silver; cursor: pointer;" width="20%" onclick="openThisForm('stationary')">Stationary Record</td>
	<td class="tdFormat" style="background-color: silver; cursor: pointer;" width="20%" onclick="openThisForm('staff')">Staff Registration</td>
	</tr>
	</table>
	</div>
	<div id="contentDiv">
