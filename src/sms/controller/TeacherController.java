...
@RequestMapping("/openAttendanceForm.htm")
public ModelAndView openAttendanceForm(@ModelAttribute("studentAttandenceFromBean")  StudentAttendanceFormBean studentAttendanceFormBean){
	
    ModelAndView mv=new ModelAndView();
    mv.setViewName("studentAttendanceForm");
    mv.addObject("userId", studentAttendanceFormBean.getClassName());
	return mv;
}

	
@RequestMapping("/attendanceStudentList.htm")
public ModelAndView studentListForAttendance(@ModelAttribute("studentAttandenceFromBean")  StudentAttendanceFormBean studentAttendanceFormBean){
	
    System.out.println("Class Name : "+studentAttendanceFormBean.getClassName());
    ModelAndView mv=new ModelAndView();
    mv.setViewName("studentAttendanceForm");
    mv.addObject("userId", studentAttendanceFormBean.getClassName());
	return mv;
	...
	@RequestMapping(value="/teacherPanel.htm", method=RequestMethod.GET)
