...
<body style="background-color: rgb(225, 248, 237);">
	...
	<div style="font-size: xx-large; color: green; text-align: center;">Staff</div>
	<center>
	...
	<td  class="tdFormat" style="background-color: silver; cursor: pointer;" width="20%" onclick="openThisForm('attendance')">Student Attendance</td>
